 ...
 *******************************************************************************/
package io.github.shimada666.packagedrone.plus.yum;
...
import io.github.shimada666.packagedrone.plus.HashAlgorithm;
import io.github.shimada666.packagedrone.plus.io.IOConsumer;
import io.github.shimada666.packagedrone.plus.io.OutputSpooler;
import io.github.shimada666.packagedrone.plus.io.SpoolOutTarget;
import io.github.shimada666.packagedrone.plus.security.pgp.SigningStream;
    ...
    private class ContextImpl implements Context
    {
        ...
        public void addPackage ( final FileInformation fileInformation, final RpmInformation info, final Map<HashAlgorithm, String> checksums, final HashAlgorithm idType )
        {
...

            {
                ...
                for ( final RpmInformation.Changelog log : info.getChangelog () )
                {
        ...
        private void addDependencies ( final Element fmt, final String elementName, final List<RpmInformation.Dependency> deps )
        {
            final Element ele = addElement ( fmt, elementName );

            for ( final RpmInformation.Dependency dep : deps )
            {
