 ...
 *******************************************************************************/
package io.github.shimada666.packagedrone.plus.info;
...
public final class RpmInformations
{
    ...
    public static List<RpmInformation.Dependency> makeDependencies (final InputHeader<RpmTag> header, final RpmTag namesTag, final RpmTag versionsTag, final RpmTag flagsTag )
    {
        ...
        final List<RpmInformation.Dependency> result = new ArrayList<> ( names.length );
